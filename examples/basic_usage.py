...
def compare_models(hist_basic, hist_bm, hist_sm):
    ...
    ax.plot(steps, [h['I'] for h in hist_basic], 
            label='Basic SEIZ', color='red', linewidth=2, linestyle='-')
    ax.plot(steps, [h['I'] for h in hist_bm], 
            label='SEIZ-BM', color='orange', linewidth=2, linestyle='--')
    ax.plot(steps, [h['I'] for h in hist_sm], 
            label='SEIZ-SM', color='purple', linewidth=2, linestyle=':')
